...
export default function ResultPage() {
      ...
      try {
        ...
        if (result?.best_resume) {
          if (typeof result.best_resume.AI_Response_Counter === "number") {
            ...
            console.warn("Unexpected response 1:", result);
          }
        } else {
          setIsProcessing(false);
          setIsResumeUploadModalOpen(true);
  ...
  const downloadPDF = (resume: ResumeAnalysis) => {
    ...
    const maxWidth = 515;
    let cursorY = 60;
    const imgWidth = 24; // Example width of the image
    const imgHeight = 16; // Example height of the image
    const imgX = margin; // X coordinate for the image
    const imgY = cursorY - imgHeight + 2; // Align image with text

    // Add image
    doc.addImage(
      "/c-screen-transparent.png",
      "PNG",
      imgX,
      imgY,
      imgWidth,
    ...
    doc.setFontSize(16);
    doc.text("C-Screen Insights", imgX + imgWidth + 5, cursorY);
    cursorY += 30;
  ...
  return (
    <>
      ...
      <div className="space-y-6 min-h-screen p-8 bg-gray-50 dark:bg-[#1A1B24] transition-colors duration-300">
        <div>
          {/* Header */}
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4">
              <span className="font-medium text-lg text-gray-700 dark:text-white transition-colors duration-300">
                Job Title:
              </span>
              <span className="font-semibold text-lg text-[#F1652E]">
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="gap-4 flex">
              ...
              <button
                className="px-6 py-2 rounded-lg text-white font-medium bg-[#F1652E] hover:bg-[#E55A29] transition-colors duration-300"
          ...
          <div className="border border-gray-200 dark:border-gray-600 bg-white dark:bg-[#1A1B24] rounded-lg overflow-hidden shadow-sm dark:shadow-none transition-colors duration-300">
            ...
            <div className="grid grid-cols-6 gap-4 p-4 border-b border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-800/30 transition-colors duration-300">
              <div className="font-medium text-lg text-[#F1652E] col-span-1">
                Candidate Name
              </div>
              <div className="font-medium text-lg text-[#F1652E] col-span-1">
                C-Screen Score
              </div>
              <div className="font-medium text-lg text-[#F1652E] col-span-3">
                C-Screen Insights
              </div>
              <div className="font-medium text-lg text-[#F1652E] col-span-1">
                Download
          ...
          <div className="mt-8 text-center">
            ...
            <p className="font-medium pt-2 text-[#F1652E]">
              Do not refresh tab.
            </p>
          </div>
        </div>
